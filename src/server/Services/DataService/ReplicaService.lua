...
do
	...
	Madwork = {
		GetShared = function(package_name, item_name)
			...
			-- edit for Rojo compatibility
			return WaitForDescendant(game.ReplicatedStorage.Shared.Modules.Madwork, item_name, "module")
		end,
...
local RateLimiter = require(Madwork.GetShared("Madwork", "MadworkRateLimiter"))
